"""
build_number
This script generate build_number files.

Usage:
    python3 build_number.py
Keys:
    -p - create pure build_number file.
         Contains only build number/
    -s - create header build_number.h file.
         Contains define BUILD_NUMBER variable.
"""
